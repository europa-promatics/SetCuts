 ...
 */
var CustomerPaymentHistoryPage = /** @class */ (function () {
    function CustomerPaymentHistoryPage(serviceProvider, navCtrl, navParams, alertCtrl, loadingCtrl, http) {
    ...
    CustomerPaymentHistoryPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad CustomerPaymentHistoryPage');
    };
    CustomerPaymentHistoryPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    CustomerPaymentHistoryPage.prototype.total = function (value1, value2) {
        return parseInt(value1) + parseInt(value2);
    };
    CustomerPaymentHistoryPage = __decorate([
        IonicPage(),
        Component({
    ...
    return CustomerPaymentHistoryPage;
}());
export { CustomerPaymentHistoryPage };
//# sourceMappingURL=customer-payment-history.js.map